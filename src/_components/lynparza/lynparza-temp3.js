                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="100%">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td height="13" style={{ background: "#fff", lineHeight: "18px", verticalAlign: "top", height: "8px", textAlign: "center" }}><a target="_blank" href={content.full_cta_link && content.full_cta_link}><img src={`lynparza_images/${content.full_cta}`} alt="" style={{ cursor: "pointer" }} /></a></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </td>
