                                ...
                                <tr>
                                    <td width="100%">
                                        <table width="100%" border="0" cellSpacing="0" cellPadding="0">
                                            <tbody>
                                                <tr>
                                                    <td width="100%" bgcolor="#004d74">
                                                        {(blue_links.blue_links_length.length === 1) ?
                                                            <>
                                                                {blue_links.blue_links_length.map(function (blue_links_length, blue_links_lengthindex) {
                                                                    return (
                                                                        <table key={blue_links_lengthindex} width="50%" border="0" cellSpacing="0" cellPadding="0" bgcolor="#004d74" style={{ "float": "left", "textAlign": "left" }} align="left">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="1%">&nbsp;</td>
                                                                                    <td width="48%">&nbsp;</td>
                                                            ...
                                                            : (blue_links.blue_links_length.length === 2) ?
                                                                <>
                                                                    <table width="50%" border="0" cellSpacing="0" cellPadding="0" bgcolor="#004d74" style={{ "float": "left", "textAlign": "left" }} align="left">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td width="1%">&nbsp;</td>
                                                                                <td width="48%">&nbsp;</td>
                                                                    ...
                                                                    <table width="2" border="0" cellSpacing="0" cellPadding="0" bgcolor="#004d74" style={{ "float": "left", "textAlign": "left" }} align="left">
                                                                        <tbody>
                                                                            <tr>
                                                                    ...
                                                                    <table width="46%" border="0" cellSpacing="0" cellPadding="0" bgcolor="#004d74" style={{ "float": "left", "textAlign": "left" }} align="right">
                                                                        <tbody>
                                                                            <tr>
