                                                        ...
                                                        <tr>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td width="10%" style={{ "color": "#fff", "backgroundColor": "#fff" }}>
                                                                                <a target="_blank" rel="noopener noreferrer" href={cta.btn_link}><img src={`images/${cta.btn_image_name && cta.btn_image_name}`} alt="" style={{ "cursor": "pointer" }} /></a>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            ...
                                                            <td className="mob_width" width="50%" valign="top">
                                                                <table align="right" className="mob_leftTable" width="50%" border="0" cellSpacing="0" cellPadding="0" bgcolor="#fbeae1" style={{ "textAlign": "right" }}>
                                                                    <tbody>
                                                                        <tr valign="top">
                                                                            <td width="10%" style={{ "color": "#fff", "backgroundColor": "#fff" }}><img src={`images/${cta.image_name && cta.image_name}`} alt="" height="152px" width="190px" style={{ "cursor": "pointer" }} />
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
