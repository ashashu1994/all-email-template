                                    ...
                                    <>
                                        <tr>
                                            ...
                                            <td style={{ backgroundColor: "#fff" }}>
                                                <table align="right" class="mob_leftTable" width="30%" border="0" cellspacing="0" cellpadding="0" bgcolor="#fbeae1" style={{ float: "left", textAlign: "right" }}>
                                                    <tbody>
                                                        <tr>
                                                            <td class="mob_space" width="20%" height="15" style={{ color: "#fff", backgroundColor: "#fff", fontSize: "1px" }}>&nbsp;</td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td width="10%" style={{ color: "#fff", backgroundColor: "#fff" }}><a target="_blank" href="#"><img src={`images/${cta.image_name}`} alt="" height="152px" width="190px" style={{ cursor: "pointer" }} class="image1" /></a></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table class="mob_width" width="50%" border="0" cellspacing="0" cellpadding="0" bgcolor="#fff" style={{ float: "left", textAlign: "left" }} align="left">
                                                    <tbody>
                                                        <tr>
                                                            <td class="mob_space" height="15" style={{ background: "#fff", fontSize: "1px", lineHeight: "15px" }}>&nbsp;</td>
                                                        </tr>
                                                        <tr>
