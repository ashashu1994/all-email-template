                                                ...
                                                <tbody>
                                                    ...
                                                    {data.template4.image_name && <>
                                                        <tr style={{ "lineHeight": "0px" }}>
                                                            <td align="center"><img src={`fasenra_images/${data.template4.image_name}`} alt="main" className="main_img" /></td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    {data.template4.btn_image_name && <>
                                                        <tr style={{ "lineHeight": "0px", "backgroundColor": "#fff" }}>
                                                            <td align="center"><a href={data.template4.btn_link}><img src={`fasenra_images/${data.template4.btn_image_name}`} alt="main" className="main_img" /></a></td>
                                                        </tr>
                                                        <tr>
                                                            <td height="15" style={{ "background": "#fff", "lineHeight": "15px", "verticalAlign": "top", "fontSize": "1px" }}>&nbsp;</td>
                                                        </tr>
