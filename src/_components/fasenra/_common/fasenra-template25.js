    ...
    render() {
        ...
        return (
            <>
                                                    ...
                                                    {data.user_name && <>
                                                        <tr>
                                                            <td height="13" style={{ background: "#fff", lineHeight: "10px", verticalAlign: "top", height: "8px", color: "#000", fontSize: "12px" }}>
                                                                {data.user_name.map(function (commonTxt, commonTxtIndex) {
                                                                    return (
                ...
                {data.template25 && <>
                    {data.template25 && data.template25.cta_heading &&
                        <tr>
                            <td width="100%">
                                <table width="100%" border="0" cellSpacing="0" cellPadding="0">
                                    <tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="mob_table" width="96%" style={{ backgroundColor: "#fff" }}>
                                                {data.template25 && data.template25.cta_image.map(function (cta, index) {
                                                    return (
                    ...
                    {data.template25 && data.template25.cta_list && <>
                        <tr>
                    ...
                    {data.template25 && data.template25.btn_image_name && <>
                        <tr>
                            <td width="100%"><table width="100%" border="0" cellSpacing="0" cellPadding="0">
                                <tbody>
                                    <tr>
