                                    ...
                                    <td >
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td height="13" style={{ background: "#fff", lineHeight: "12px", verticalAlign: "top", height: "13px", color: "#000", fontSize: "12px", fontWeight: "bold" }}>{data.cta_heading}</td>
                                                </tr>
                                                <tr>
                                                    <td height="13" style={{ background: "#fff", lineHeight: "10px", verticalAlign: "top", height: "8px", fontSize: "1px" }}>&nbsp;</td>
                                                </tr>
                                ...
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            ...
                                            {data.cta_list.map(function (cta, index) {
                                                return (
                                                    <>
                                                        <tr>
                ...
                <tr>
                    <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td height="13" style={{ background: "#fff", lineHeight: "12px", verticalAlign: "top", height: "8px", textAlign: "center" }}><a rel="noopener noreferrer" target="_blank" href={data.btn_link}><img src={`images/${data.btn_image_name}`} alt="" style={{ cursor: "pointer" }} /></a></td>
                                </tr>
                            </table></td>
                            <td width="1%">&nbsp;</td>
                        </tr>
