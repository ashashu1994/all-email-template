                                ...
                                <td>
                                    <table width="100%" border="0" cellSpacing="0" cellPadding="0" bgcolor={data.bgColor ? data.bgColor : "#fff"}>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td height="13" style={{ background: `${data.bgColor ? data.bgColor : "#fff"}`, lineHeight: "15px", color: `${data.textColor ? data.textColor : "#000"}`, verticalAlign: "top", height: "8px", textAlign: "left", fontSize: "15px" }}>
